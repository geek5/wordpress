...
function blossom_magazine_customize_register_general( $wp_customize ){
    ...
    $wp_customize->add_control(
        ...
        array(
            'section'         => 'instagram_settings',
            'label'           => __( 'Shortcode', 'blossom-magazine' ),
            'type'            => 'text',
            'description'     => __( 'Add shortcode for your instagram profile below:', 'blossom-magazine' ),
            'active_callback' => 'blossom_magazine_instagram_ac',
        )
    );
