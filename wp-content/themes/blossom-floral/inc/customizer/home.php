...
function blossom_floral_customize_register_frontpage($wp_customize) {
    ...
    $wp_customize->add_control(
        ...
        array(
            'section'         => 'instagram_settings',
            'label'           => __( 'Shortcode', 'blossom-floral' ),
            'type'            => 'text',
            'description'     => __( 'Add shortcode for your instagram profile below:', 'blossom-floral' ),
            'active_callback' => 'blossom_floral_instagram_ac',
        )
    );    
