...
function spa_and_salon_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'spa-and-salon' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/previews/?theme='.SPA_AND_SALON_THEME_TEXTDOMAIN.'' ) . '" target="_blank">' . __( 'here', 'spa-and-salon' ) . '</a></span><br />';
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme info', 'spa-and-salon' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/wordpress-themes/'.SPA_AND_SALON_THEME_TEXTDOMAIN.'/' ) . '" target="_blank">' . __( 'here', 'spa-and-salon' ) . '</a></span><br />';
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Rate this theme', 'spa-and-salon' ) . ': </label><a href="' . esc_url( 'https://wordpress.org/support/theme/'.SPA_AND_SALON_THEME_TEXTDOMAIN.'/reviews/' ) . '" target="_blnak">' . __( 'here', 'spa-and-salon' ) . '</a></span><br />';
